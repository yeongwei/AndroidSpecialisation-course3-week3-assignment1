package edu.vandy.mooc.aad_3_assg_2.assignment.activities;
...
import edu.vandy.mooc.aad_3_assg_2.assignment.services.DownloadAtomFeedService;
import edu.vandy.mooc.aad_3_assg_2.assignment.services.utils.ServiceResult;
import edu.vandy.mooc.aad_3_assg_2.assignment.services.utils.ServiceResultHandler;
import edu.vandy.mooc.aad_3_assg_2.framework.Interfaces.UpdateEntriesInterface;
import edu.vandy.mooc.aad_3_assg_2.framework.common.activities.CustomLoggingActivityBase;
import edu.vandy.mooc.aad_3_assg_2.framework.common.logger.Log;
import edu.vandy.mooc.aad_3_assg_2.framework.common.logger.LogFragment;
import edu.vandy.mooc.aad_3_assg_2.framework.common.logger.LogWrapper;
import edu.vandy.mooc.aad_3_assg_2.framework.common.logger.MessageOnlyLogFilter;
...
public class MainActivity extends CustomLoggingActivityBase implements ServiceResult {
     ...
     *
     * @param outState the bundle to store the state out to
     */
    @Override
