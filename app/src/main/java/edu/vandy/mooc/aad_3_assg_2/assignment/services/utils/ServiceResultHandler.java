package edu.vandy.mooc.aad_3_assg_2.assignment.services.utils;
...
public class ServiceResultHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        ...
        final int requestCode =
                DownloadAtomFeedService.getRequestCode(message);
        final int resultCode =
                DownloadAtomFeedService.getResultCode(message);
