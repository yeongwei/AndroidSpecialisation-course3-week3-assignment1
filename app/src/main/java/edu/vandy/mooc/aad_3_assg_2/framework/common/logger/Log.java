 ...
 */
package edu.vandy.mooc.aad_3_assg_2.framework.common.logger;
...
public class Log {
    ...
    // to make for easy migration and inter-op.
   ...
   /**
     ...
     *           to extract and print useful information.
     */
    private static void wtf(String tag, String msg, Throwable tr) {
